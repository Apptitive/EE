...
Module.constant('datePickerConfig', {
  template: 'views/datepicker.html',
  view: 'month',
...
Module.directive('datePicker', ['datePickerConfig', 'datePickerUtils', function datePickerDirective(datePickerConfig, datePickerUtils) {
  ...
  return {
    ...
    link: function (scope, element, attrs) {
      ...
      scope.setDate = function (date,tr,td) {
        if(attrs.disabled) {
          return;
        }
        scope.tr = tr;
        ...
        loginScope.pageContent.currentDate = date.getDate()+"-"+(date.getMonth()+1);

        //console.log(JSON.stringify(loginScope.pageContent.dateFilterJob[loginScope.pageContent.currentDate]));
        //console.log('set date')
          setTimeout(function(){
             $('[date-picker] .now').removeClass('now');
             loginScope.$apply();
          },100)
         
          setTimeout(function(){
            $('td #'+scope.tr+'_week'+scope.td+'_day').removeClass('active');
            $('td #'+scope.tr+'_week'+scope.td+'_day').addClass('now');
          },300);
      };
      ...
      scope.isSelected = function (date) {
        return datePickerUtils.isSelected(date);
      };
